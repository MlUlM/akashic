...
#[inline]
pub fn expand_object_2d_derive(input: TokenStream) -> TokenStream {
    try_expand_object_2d_derive(input)
        .unwrap_or_else(|e| e.into_compile_error())
        .into()
}


pub(crate) fn try_expand_object_2d_derive(input: TokenStream) -> syn::Result<TokenStream2> {
