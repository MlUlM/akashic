...
//
// use crate::plugin::akashic_3d::ScreenSurface;
//
...
//
//         let akashic_surface = app.world.non_send_resource::<ScreenSurface>();
...
//         let akashic_surface = world.non_send_resource::<ScreenSurface>();
